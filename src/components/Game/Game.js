...
class Game extends React.Component {
  ...
  triggerGallows(n) {
    ...
    if(n === 10) setTimeout(()=>alert("PRZEGRANA"), 2000);
  }
  componentDidMount() {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    if (snapshot !== null) {
      ...
      if (this.wordLeftovers.length === 0) setTimeout(() => alert('FINISZ'), 500);
    }
  }
  render() {
    let i = 0;
      ...
      <div className="game">
        <div className="game__graphics">
          <svg xmlns="http://www.w3.org/2000/svg" width="249" height="389" version="1.1" viewBox="0 0 64.327 102.923">
            ...
            <path ref={this.gallows[5]} d="m 56.124933,213.69341 a 7.6729164,7.6729164 0 0 1 7.67291,7.67292 7.6729164,7.6729164 0 0 1 -7.67291,7.67291 7.6729164,7.6729164 0 0 1 -7.67292,-7.67291 7.6729164,7.6729164 0 0 1 7.67292,-7.67292 z" />
